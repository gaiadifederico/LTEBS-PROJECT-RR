...
void INT1_SetVector(cyisraddress address)
{
    ...
    ramVectorTable[CYINT_IRQ_BASE + (uint32)INT1__INTC_NUMBER] = address;
}
...
cyisraddress INT1_GetVector(void)
{
    ...
    return ramVectorTable[CYINT_IRQ_BASE + (uint32)INT1__INTC_NUMBER];
}
